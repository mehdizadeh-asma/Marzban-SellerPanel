...
const AddSeller = forwardRef(
  ({ onAdding, onFieldChange, mode, seller }: PropsType, ref): ReactElement | null => {
    ...
    const noop = (): void => {};
    const onChangeTitle = (): void => handleInputChange("Title", txtTitle);
    const onChangeLimit = (): void => handleInputChange("Limit", txtLimit);
    const onChangeUsername = (): void => handleInputChange("Username", txtUsername);
    const onChangePassword = (): void => handleInputChange("Password", txtPassword);
    const onChangeMarzbanUsername = (): void =>
      handleInputChange("MarzbanUsername", txtMarzbanUsername);
    const onChangeMarzbanPassword = (): void =>
          ...
          <div className="row py-1 my-1">
            <div className="col-12 ">
              <TextField
                ...
                label="Title"
                variant="outlined"
                onChange={mode === "Edit" ? onChangeTitle : noop}
              />
            </div>
          </div>
          <div className="row py-1 my-1">
            <div className="col-12 ">
              <TextField
                ...
                type="number"
                inputRef={txtLimit}
                onChange={mode === "Edit" ? onChangeLimit : noop}
              />
            </div>
          </div>
          <div className="row py-1 my-1">
            <div className="col-12 py-1 ">
              <TextField
                ...
                onChange={mode === "Edit" ? onChangeUsername : noop}
              />
            </div>
          </div>
          <div className="row py-1 my-1">
            <div className="col-12 py-1">
              <TextField
                ...
                onChange={mode === "Edit" ? onChangePassword : noop}
              />
            </div>
          </div>
          <div className="row py-1 my-1">
            <div className="col-12 py-1 ">
              <TextField
                ...
                onChange={mode === "Edit" ? onChangeMarzbanUsername : noop}
              />
            </div>
          </div>
          <div className="row py-1 my-1">
            <div className="col-12 py-1">
              <TextField
                ...
                onChange={mode === "Edit" ? onChangeMarzbanPassword : noop}
              />
            </div>
          </div>
          <div className="row">
